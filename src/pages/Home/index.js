  ...
  <main id="main">
        ...
        <div className="row">
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/1.jpg" alt="Speaker 1" className="img-fluid"/>
          ...
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/2.jpg" alt="Speaker 2" className="img-fluid"/>
              <div className="details">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/3.jpg" alt="Speaker 3" className="img-fluid"/>
              <div className="details">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/4.jpg" alt="Speaker 4" className="img-fluid"/>
              <div className="details">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/5.jpg" alt="Speaker 5" className="img-fluid"/>
              <div className="details">
          ...
          <div className="col-lg-4 col-md-6">
            <div className="speaker">
              <img src="./assets_front/img/speakers/6.jpg" alt="Speaker 6" className="img-fluid"/>
              <div className="details">
        ...
        <div className="tab-content row justify-content-center">
          ...
          <div role="tabpanel" className="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/1.jpg" alt="Brenden Legros"/>
                </div>
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/2.jpg" alt="Hubert Hirthe"/>
                </div>
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/3.jpg" alt="Cole Emmerich"/>
                </div>
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/4.jpg" alt="Jack Christiansen"/>
                </div>
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/5.jpg" alt="Alejandrin Littel"/>
                </div>
            ...
            <div className="row schedule-item">
              ...
              <div className="col-md-10">
                <div className="speaker">
                  <img src="./assets_front/img/speakers/6.jpg" alt="Willow Trantow"/>
                </div>
    ...
    <section id="gallery" className="wow fadeInUp">
      ...
      <div className="owl-carousel gallery-carousel">
        <a href="img/gallery/1.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/1.jpg" alt=""/></a>
        <a href="img/gallery/2.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/2.jpg" alt=""/></a>
        <a href="img/gallery/3.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/3.jpg" alt=""/></a>
        <a href="img/gallery/4.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/4.jpg" alt=""/></a>
        <a href="img/gallery/5.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/5.jpg" alt=""/></a>
        <a href="img/gallery/6.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/6.jpg" alt=""/></a>
        <a href="img/gallery/7.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/7.jpg" alt=""/></a>
        <a href="img/gallery/8.jpg" className="venobox" data-gall="gallery-carousel"><img src="./assets_front/img/gallery/8.jpg" alt=""/></a>
      </div>
        ...
        <div className="row no-gutters supporters-wrap clearfix">
          ...
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/1.png" className="img-fluid" alt=""/>
            </div>
          </div>
          
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/2.png" className="img-fluid" alt=""/>
            </div>
          </div>
        
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/3.png" className="img-fluid" alt=""/>
            </div>
          </div>
          
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/4.png" className="img-fluid" alt=""/>
            </div>
          </div>
          
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/5.png" className="img-fluid" alt=""/>
            </div>
          </div>
        
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/6.png" className="img-fluid" alt=""/>
            </div>
          </div>
          
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/7.png" className="img-fluid" alt=""/>
            </div>
          </div>
          
          <div className="col-lg-3 col-md-4 col-xs-6">
            <div className="supporter-logo">
              <img src="./assets_front/img/supporters/8.png" className="img-fluid" alt=""/>
            </div>
          </div>
