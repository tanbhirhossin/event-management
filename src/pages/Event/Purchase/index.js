...
function Purchase() {
  ...
  const [inputs, setInputs] = useState({ id: '', employee_id: userdata.id, event_id: event_id, purchase_date: '', vendor_id: '', total: '', discount: '', tax: '', gtotal: '', discountamt: '', taxamt: '', check_date: '', bank_name: '', check_number: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/Event');// route from app.js
    }
    catch (e) {
      console.log(e);
    }
